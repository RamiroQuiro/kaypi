...
export default function SidebarDiseño() {
  ...
  console.log(activo);
  return (
    <aside className="absolute right-0 py-5 bg-white top-20 w-1/6 h-full shadow-lg">
      <label htmlFor="colorSelect" className="font-bold w-full ">
        Colores
        <svg
      ...
      <div className="flex flex-col h-2/3 px-3 py-10 justify-evenly  items-center w-full ">
        {/*  */}
