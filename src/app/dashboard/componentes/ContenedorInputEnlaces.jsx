...
export default function ContenedorInputEnlaces() {
  ...
  return (
    <form className="relative   flex group pb-5 flex-col items-start justify-between w-full bg-gray-100 border-2 gap-y-3 rounded-2xl p-3 my-2">
      ...
      <div className="flex flex-col items-start text-sm  justify-betwwwen w-full ">
        ...
        <input
          ...
          name="name"
          id="titlo"
          className="bg-transparent outline-none focus:outline-none  rounded-t-lg focus:bg-white duration-300 border-b-2 w-full p-2 placeholder:px-2 focus:ring-0 border-primary-100/50 selection:border-none"
        />
      </div>
      <div className="flex flex-col items-start text-sm  justify-betwwwen w-full">
