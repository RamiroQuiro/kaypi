...
export default function SectionTarjetaSola() {
  return (
    <section className="bg-white border relative  rounded-lg overflow-hidden lg:w-[25vw] z-20  md:w-[35vw] w-full md:h-[95vh]  shadow-shadowCaja1 relative h-[98vh]  flex flex-col items-center justify-between ">
