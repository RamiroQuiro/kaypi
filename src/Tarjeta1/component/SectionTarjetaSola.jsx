...
export default function SectionTarjetaSola() {
  return (
    <section className="bg-white border capitalize rounded-lg lg:w-[30vw]  md:w-[50vw] w-full md:h-[90vh] shadow-shadowCaja1 relative h-full z-20 flex flex-col items-center justify-between ">
