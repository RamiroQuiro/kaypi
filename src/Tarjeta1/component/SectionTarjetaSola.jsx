...
className="bg-white border capitalize rounded-lg lg:w-[25vw] z-0  md:w-[25vw] w-full md:h-[100vh] shadow-shadowCaja1 relative h-[98vh]  flex flex-col items-center justify-between ">
