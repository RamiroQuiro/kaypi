...
export default function LinksSquare() {
  ...
  return (
      ...
      <div className="w-10 h-10 rounded-lg bg-neutral-50 p-2 shadow-md delay-200 animate-[aparecer_3s]">
        <svg
      ...
      <div className="w-10 h-10 rounded-lg bg-neutral-50 p-2 shadow-md delay-300 animate-[aparecer_3s]">
        <svg
          className="w-full h-full fill-primary-100"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="w-10 h-10 rounded-lg bg-neutral-50 p-2 shadow-md delay-500 animate-[aparecer_4s]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          className="w-full h-full fill-primary-100"
