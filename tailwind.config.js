...
module.exports = {
  ...
  theme: {
    clipPath: {
      ...
      patron:"path(M96, 428.9c0 0, 96 78, 174 51, 48-16.6, 68-93.3, 198-99, 56.4-2.5, 170.2, 22.3, 255 48.1, 168.9 51.3, 313.7 75.4, 379.5 67.4, 68.6-8.4 ,250.5-55.2, 250.5-112.5 ,0-241.7-1.5-383.9-1.5-383.9h-1251l-10.5 419.9zm-1, 0.1)",
      url:"url(#heroShape)",
